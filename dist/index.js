...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const release = yield new version_1.Version(version).get();
...
class Version {
    ...
    constructor(wantVer, client) {
        this.wantVer = wantVer;
        this.client = client;
        if (!client) {
    ...
    getRelease(version) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!semver.valid(version)) {
                return yield this.resolveVersion(version);
            }
            const url = `${RELEASES_URL}/tags/${version}`;
            const res = yield this.httpClient.getJson(url);
            if (!(res === null || res === void 0 ? void 0 : res.result) || (res === null || res === void 0 ? void 0 : res.statusCode) < 200 || (res === null || res === void 0 ? void 0 : res.statusCode) >= 300) {
                throw Error(`Cannot find Gremlins release ${version}`);
            }
            return (_a = res === null || res === void 0 ? void 0 : res.result) === null || _a === void 0 ? void 0 : _a.tag_name;
        });
    }
    resolveVersion(version) {
        return __awaiter(this, void 0, void 0, function* () {
            const allTags = yield this.getAllTags();
    ...
    getAllTags() {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.httpClient.getJson(RELEASES_URL);
            if (!(res === null || res === void 0 ? void 0 : res.result) || (res === null || res === void 0 ? void 0 : res.statusCode) < 200 || (res === null || res === void 0 ? void 0 : res.statusCode) >= 300) {
